...
type EmailConfiguration struct {
	...
	AdminTwoFactorMethodRemoveEmailTemplateId string                 `json:"adminTwoFactorMethodRemoveEmailTemplateId,omitempty"`
	Debug                                     bool                   `json:"debug"`
...
type TenantPhoneConfiguration struct {
	AdminTwoFactorMethodRemoveTemplateId string                 `json:"adminTwoFactorMethodRemoveTemplateId,omitempty"`
	ForgotPasswordTemplateId             string                 `json:"forgotPasswordTemplateId,omitempty"`
	IdentityUpdateTemplateId             string                 `json:"identityUpdateTemplateId,omitempty"`
