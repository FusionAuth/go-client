...
//   string loginId The email or username of the user.
//   List<String> loginIdTypes The identity types that FusionAuth will compare the loginId to.
func (c *FusionAuthClient) RetrieveUserByLoginId(loginId string, loginIdTypes List<String>) (*UserResponse, *Errors, error) {
    return c.RetrieveUserByLoginIdWithContext(context.TODO(), loginId, loginIdTypes)
}
...
//   string loginId The email or username of the user.
//   List<String> loginIdTypes The identity types that FusionAuth will compare the loginId to.
func (c *FusionAuthClient) RetrieveUserByLoginIdWithContext(ctx context.Context, loginId string, loginIdTypes List<String>) (*UserResponse, *Errors, error) {
    var resp UserResponse
    var errors Errors
...
//   int64 start The start instant as UTC milliseconds since Epoch.
//   int64 end The end instant as UTC milliseconds since Epoch.
func (c *FusionAuthClient) RetrieveUserLoginReportByLoginId(applicationId string, loginId string, loginIdTypes List<String>, start int64, end int64) (*LoginReportResponse, *Errors, error) {
    return c.RetrieveUserLoginReportByLoginIdWithContext(context.TODO(), applicationId, loginId, loginIdTypes, start, end)
}
...
//   int64 start The start instant as UTC milliseconds since Epoch.
//   int64 end The end instant as UTC milliseconds since Epoch.
func (c *FusionAuthClient) RetrieveUserLoginReportByLoginIdWithContext(ctx context.Context, applicationId string, loginId string, loginIdTypes List<String>, start int64, end int64) (*LoginReportResponse, *Errors, error) {
    var resp LoginReportResponse
    var errors Errors
